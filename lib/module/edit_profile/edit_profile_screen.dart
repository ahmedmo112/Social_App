  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SocialCubit, SocialStates>(listener: (context, state) {
      ...
      if (state is SocialUserUpdateSuccessState) {
        ...
        showToast(text: 'Updated successfuly', state: ToastStates.SUCCESS);
      } else if (state is SocialUserUpdateErrorState) {
        
        showToast(text: 'Updated successfuly', state: ToastStates.ERROR);
      }
      ...
      return Scaffold(
        appBar:
          ...
          TextButton(
              onPressed: () {
                SocialCubit.get(context).checkBeforeUpdateUserData(
